...
const routes: Routes = [
  ...
  },
  {
    path: 'Vehicle-Search',
    loadChildren: () =>
      import('./../vehicle-search/vehicle-search.module').then((n) => n.VehicleSearchModule),
    data: {
  ...
  },
  {
    path: 'MakeMaster',
    loadChildren: () =>
      import('../admin/Masters/make-master/make-master.module').then((n) => n.MakeMasterModule),
      data: {
        title: "Make Master",
  ...
  },
  {
    path: 'ModelMaster',
    loadChildren: () =>
      import('../admin/Masters/model-master/model-master.module').then((n) => n.ModelMasterModule),
      data: {
        title: "Model Master",
  ...
  },
  {
    path: 'BodyTypeMaster',
    loadChildren: () =>
      import('../admin/Masters/bodyTypeMaster/existing-body-type-master/existing-body-type-master.module').then((n) => n.ExistingBodyTypeMasterModule),
      data: {
  ...
  },
  {
    path: 'ColorMaster',
    loadChildren: () =>
      import('../admin/Masters/color-master/color-master.module').then((n) => n.ColorMasterModule),
      data: {
        title: "Color Master",
  ...
  },
  {
    ...
    loadChildren: () =>
      import('../admin/Masters/insurance-master/insurance-master.module').then((n) => n.InsuranceMasterModule),
      data: {
