...
@Component({
  selector: 'app-recovery-grid',
  templateUrl: './recovery-grid.component.html',
  styleUrls: ['./recovery-grid.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class RecoveryGridComponent implements OnInit {
